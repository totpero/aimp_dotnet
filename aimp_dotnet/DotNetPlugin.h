...
{
public:
	ManagedFunctionality(AIMPSDK::IAIMPCore* core, ManagedAimpCore ^managedCore)
	{
		_core = core;
...
private:
	AIMPSDK::IAIMPCore* _core;
	ManagedAimpCore ^_managedCore;
};

class DotNetPlugin : public IUnknownInterfaceImpl<AIMPSDK::IAIMPPlugin>
{
public:
	DotNetPlugin();
	...
	virtual HRESULT WINAPI Initialize(AIMPSDK::IAIMPCore* core);
...
private:
	HRESULT LoadExtensions(AIMPSDK::IAIMPCore* core);

public:
	gcroot<AIMP::SDK::ManagedAimpCore^> _managedCore;
...
class OptionFrame : public IUnknownInterfaceImpl<AIMPSDK::IAIMPOptionsDialogFrame>
{
private:
	gcroot<AIMP::SDK::ManagedAimpCore^> _core;	
	gcroot<AIMP::SDK::UI::SettingsForm^> _settingForm;
	AIMPSDK::IAIMPServiceOptionsDialog *_serviceOptionsDialog;
...
public:
	OptionFrame(AIMP::SDK::ManagedAimpCore^ core, DotNetPlugin* main)
	{
		_core = core;
		_LinkCounter = 1;
		_main = main;
