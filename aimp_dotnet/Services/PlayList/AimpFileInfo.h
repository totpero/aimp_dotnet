	...
	namespace PlayList
	{
		...
		public:
			AimpFileInfo()
			{
				...
				(IAIMPFileInfo*)AIMP::SDK::ManagedAimpCore::GetAimpCore()->CreateObject(IID_IAIMPFileInfo, (void**)&fileInfo);
			...
			virtual property System::Drawing::Bitmap^ AlbumArt
			{
				System::Drawing::Bitmap^ get()
				{
					...
					AIMP::SDK::ManagedAimpCore::GetAimpCore()->CreateObject(IID_IAIMPImageContainer, (void**) &container);
					...
					{
						IAIMPImage *image;
						AIMP::SDK::ManagedAimpCore::GetAimpCore()->CreateObject(IID_IAIMPImage, (void**) &image);
			...
			{
				IAIMPFileInfo* clone;
				AIMP::SDK::ManagedAimpCore::GetAimpCore()->CreateObject(IID_IAIMPFileInfo, (void**)&clone);
